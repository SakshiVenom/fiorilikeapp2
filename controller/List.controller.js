sap.ui.define([
    ...
    return BaseController.extend("at.tech.app.fioirilikeapp2.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("PRODUCT_ID", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "at.tech.app.fioirilikeapp2.view.ViewSettingsDialog",
                    controller: this
