		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Products Application",
									"targetURL": "#attechappfioirilikeapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"attechappfioirilikeapp2-display": {
								"semanticObject": "attechappfioirilikeapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.tech.app.fioirilikeapp2",
									"url": sap.ui.require.toUrl("at/tech/app/fioirilikeapp2")
								}
							}
						}
					}
